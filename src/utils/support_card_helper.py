...
_support_card_effect_name_mapping = {
    SupportCardEffectType.SpecialTagEffectUp.value : "友情加成",
    SupportCardEffectType.MotivationUp.value : "干劲效果提升",
    SupportCardEffectType.TrainingSpeedUp.value : "速度加成",
    SupportCardEffectType.TrainingStaminaUp.value : "耐力加成",
    SupportCardEffectType.TrainingPowerUp.value : "力量加成",
    SupportCardEffectType.TrainingGutsUp.value : "根性加成",
    SupportCardEffectType.TrainingWizUp.value : "智力加成",
    SupportCardEffectType.TrainingEffectUp.value : "训练效果提高",
    SupportCardEffectType.InitialSpeedUp.value : "初始速度提升",
    SupportCardEffectType.InitalStaminaUp.value : "初始耐力提升",
    SupportCardEffectType.InitialPowerUp.value : "初始力量提升",
    SupportCardEffectType.InitialGutsUp.value : "初始根性提升",
    SupportCardEffectType.InitialWizUp.value : "初始智力提升",
    SupportCardEffectType.InitalEvaluationUp.value : "初始羁绊提升",
    ...
    SupportCardEffectType.EventRecoveryAmountUp.value : "事件回复量提升",
    SupportCardEffectType.TrainingFailureRateDown.value : "失败率降低",
    SupportCardEffectType.EventEffetcUp.value : "事件效果提升",
    SupportCardEffectType.TrainingHPConsumptionDown.value : "体力消耗降低",
    SupportCardEffectType.MinigameEffectUP.value : "ミニゲーム効果アップ",
    SupportCardEffectType.SkillPointBonus.value : "技能点加成",
    SupportCardEffectType.WizRecoverUp.value : "智力友情回复量提升",
    SupportCardEffectType.RaceStatusUp.value : "比赛加成",
    SupportCardEffectType.RaceFanUp.value : "粉丝数加成",
    SupportCardEffectType.SkillTipsLvUp.value : "启发等级提升",
    SupportCardEffectType.SkillTipsEventRateUp.value : "启发出现率提升",
    SupportCardEffectType.GoodTrainingRateUp.value : "擅长率提升",
    41: "全属性加成", # 只有神鹰有此词条
}
